...
물론 `manual`은 타자로 치기에 너무 길 것입니다. 그 말인즉 필자를 포함해
유닉스 세상의 누구도 그 만큼을 치고 싶어하지 않습니다. 물론 저는
본인이 얼마나 간결한 것을 선호하는지에 대해서 이렇게 저렇게 길게 늘여서
말할 수 있을 것입니다. 그러나 저는 본인이 얼마나 완전히 놀라우리만치
사실상 총체적인 모든 상황에서 간결하기를 선호하는지에 대해서 긴 웅변을
늘어놓는 대신 짧게 말하도록 하겠습니다.

_[박수 소리]_

이 글을 읽어주는 독자들에게 감사합니다. 필자가 말하는 바는 이런 페이지들이
유닉스 세상에서 "man page"라고 불린다는 것입니다. 그리고 독자 여러분의 읽는
재미를 위해서 저의 개인적인 축약판을 여기에 포함해두었다. 그 말인 즉
이 함수들 대개는 저의 사용법보다 훨씬 더 범용적이지만 저는 인터넷
소켓 프로그래밍에 연관된 부분만을 제시할 것이라는 의미입니다.

그러나 잠깐! 저의 man page에서 잘못된 부분은 이것만이 아닙니다.

- 그것은 불완전하고 안내서의 기본적인 부분만을 보여줍니다.
...
100% 성공할 것이라고 가정하지 않는 이상 오류 확인을 언제나 해야합니다.
