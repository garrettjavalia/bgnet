...
이것은 분명히 어떤 의미로든 *완벽하고 완전한* 소켓 프로그래밍 가이드는 아닙니다.
...
## 옮긴이의 말: 원문 3.1.5 기반 한국어판 {#translators-note-3-1-5}
...
## 옮긴이의 말: 2026년 개정판, 원문 3.1.5 이후 변경 반영 {#translators-note-2026}

<!-- 이 절은 2026년 업스트림 변경 반영판을 기준으로 옮긴이가 직접 작성할 공간입니다. -->
