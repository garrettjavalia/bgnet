...
게임이나 오디오, 비디오같은 신뢰할 수 없는 응용프로그램의 경우 유실된 패킷을
...
보내고 잊어버리는(fire-and-forget) 방식이 무엇이 안전하게 도착했는지 추적하고
...
에 대해서 이야기할 수 있습니다. 이 네트워크 모델은 네트워크 기능의 체계(system)
...
실제 네트워크 하드웨어와 망 구성 방식(topology)는 소켓 프로그래머에게
