...
function]] `socket()` 시스템 콜을 호출하면 된다는 것입니다. 그것은 [i[Socket
...
[i[Raw sockets]] raw 소켓도 있으며 아주 강력하니 여러분도 한 번쯤
살펴보시길 권한다는 지금 이 문장을 제외하고 말입니다.
...
수 있는 한 가장 물리 계층에서 먼 것입니다. 사용자가 실제로 네트워크와
상호작용하는 부분을 의미합니다.
